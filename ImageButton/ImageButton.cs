...
namespace ObjectX.Forms
{
	public class ImageButton : View
	{
		...
		public static BindableProperty CommandProperty = BindableProperty.Create<ImageButton, ICommand>(o => o.Command, null);
		...
		public static BindableProperty ImageProperty = BindableProperty.Create<ImageButton, ImageSource>(o => o.Image, null);
